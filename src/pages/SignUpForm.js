    ...
    render() {
        return(
            <div className="FormCenter">
                <form onSubmit={this.handleChange} className="FormFields">
                    ...
                    <div className="FormField">
                        <label className="FormField__CheckboxLabel">
                            <input className="FormField__Checkbox" type="checkbox" name="hasAgreed" value={this.state.hasAgreed} onChange={this.handleChange}/>I agree all
